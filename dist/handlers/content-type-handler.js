...
class ContentTypeHandler extends resource_handler_1.CleanableResourceHandler {
    ...
    import(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield installTypes(context, dc_demostore_integration_1.getCodecs().map(dc_demostore_integration_1.getContentType));
            ...
            yield installTypes(context, lodash_1.default.filter(Object.values(jsonTypes), s => !lodash_1.default.includes(lodash_1.default.map(dc_demostore_integration_1.getCodecs(), 'schema.uri'), s.contentTypeUri)));
