...
exports.handler = (0, middleware_1.contextHandler)((context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let contentTypeSchemas = yield (0, dc_demostore_integration_1.paginator)(context.hub.related.contentTypeSchema.list, { status: 'ACTIVE' });
    let contentTypes = yield (0, dc_demostore_integration_1.paginator)(context.hub.related.contentTypes.list, { status: 'ACTIVE' });
    let count = lodash_1.default.zipObject(lodash_1.default.map(repositories, r => r.name || ''), yield Promise.all(repositories.map((repo) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        let x = (yield (0, dc_demostore_integration_1.paginator)(repo.related.contentItems.list, { status: 'ACTIVE' })).length;
    ...
    count.searchIndexes = (yield (0, dc_demostore_integration_1.paginator)((0, dc_demostore_integration_1.searchIndexPaginator)(context.hub), { status: 'ACTIVE' })).length;
    (0, logger_1.logUpdate)(`reading extensions...`);
    count.extensions = (yield (0, dc_demostore_integration_1.paginator)(context.hub.related.extensions.list, { status: 'ACTIVE' })).length;
    (0, logger_1.logUpdate)(`reading webhooks...`);
    count.webhooks = (yield (0, dc_demostore_integration_1.paginator)(context.hub.related.webhooks.list, { status: 'ACTIVE' })).length;
    (0, logger_1.logUpdate)(`reading events...`);
    count.events = (yield (0, dc_demostore_integration_1.paginator)(context.hub.related.events.list, { status: 'ACTIVE' })).length;
