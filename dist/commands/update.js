...
exports.handler = (0, middleware_1.contextHandler)((context) => __awaiter(void 0, void 0, void 0, function* () {
    let envConfig = yield (0, amplience_helper_1.getEnvConfig)(context);
    let commerceAPI = yield (0, dc_demostore_integration_1.getCommerceAPI)(envConfig.commerce);
    ...
    let { hub } = context;
    yield hub.contentItemIterator((contentItem) => __awaiter(void 0, void 0, void 0, function* () {
        if (contentItem.body._meta.schema === 'https://demostore.amplience.com/content/curated-product-grid') {
            ...
            yield (0, amplience_helper_1.publishContentItem)(contentItem);
        }
    ...
    yield Promise.all(contentTypeSchemas.map((schema) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (schema.schemaId === 'https://demostore.amplience.com/content/product-grid' && schema.body) {
            ...
            if (contentType) {
                yield (0, amplience_helper_1.synchronizeContentType)(contentType);
            }
            else {
